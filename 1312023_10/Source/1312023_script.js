            var mod = angular.module('1312023_CV',[])
			    ...
			    $scope.disableEditorUniversity();
			  	...
			  	$scope.savecontent_hight_school = function () {
			  	    ...
			  	    $scope.editorEnabledtitle_top_skill = false;

			  	    $scope.enableEditortitle_top_skill = function () {
			  	        $scope.editorEnabledtitle_top_skill = true;
			  	        $scope.editabletitle_top_skill = $scope.title_top_skill;
			  	    };

			  	    $scope.disableEditortitle_top_skill = function () {
			  	        $scope.editorEnabledtitle_top_skill = false;
			  	    };

			  	    $scope.savetitle_top_skill = function () {
			  	        $scope.title_top_skill = $scope.editabletitle_top_skill;
			  	        $scope.disableEditortitle_top_skill();

			  	    };


			  	    $scope.editorEnabledNum_1_top_skill = false;

			  	    $scope.enableEditorNum_1_top_skill = function () {
			  	        $scope.editorEnabledNum_1_top_skill = true;
			  	        $scope.editableNum_1_top_skill = $scope.Num_1_top_skill;
			  	    };

			  	    $scope.disableEditorNum_1_top_skill = function () {
			  	        $scope.editorEnabledNum_1_top_skill = false;
			  	    };

			  	    $scope.saveNum_1_top_skill = function () {
			  	        $scope.Num_1_top_skill = $scope.editableNum_1_top_skill;
			  	        $scope.disableEditorNum_1_top_skill();
			  	    };

			  	    $scope.editorEnabledNum_2_top_skill = false;

			  	    $scope.enableEditorNum_2_top_skill = function () {
			  	        $scope.editorEnabledNum_2_top_skill = true;
			  	        $scope.editableNum_2_top_skill = $scope.Num_2_top_skill;
			  	    };

			  	    $scope.disableEditorNum_2_top_skill = function () {
			  	        $scope.editorEnabledNum_2_top_skill = false;
			  	    };

			  	    $scope.saveNum_2_top_skill = function () {
			  	        $scope.Num_2_top_skill = $scope.editableNum_2_top_skill;
			  	        $scope.disableEditorNum_2_top_skill();
			  	    };

			  	        $scope.editorEnabledNum_3_top_skill = false;

			  	        $scope.enableEditorNum_3_top_skill = function () {
			  	            $scope.editorEnabledNum_3_top_skill = true;
			  	            $scope.editableNum_3_top_skill = $scope.Num_3_top_skill;
			  	        };

			  	        $scope.disableEditorNum_3_top_skill = function () {
			  	            $scope.editorEnabledNum_3_top_skill = false;
			  	        };

			  	        $scope.saveNum_3_top_skill = function () {
			  	            $scope.Num_3_top_skill = $scope.editableNum_3_top_skill;
			  	            $scope.disableEditorNum_3_top_skill();
			  	    };

			  	        $scope.editorEnabledNum_4_top_skill = false;

			  	        $scope.enableEditorNum_4_top_skill = function () {
			  	            $scope.editorEnabledNum_4_top_skill = true;
			  	            $scope.editableNum_4_top_skill = $scope.Num_4_top_skill;
			  	        };

			  	        $scope.disableEditorNum_4_top_skill = function () {
			  	            $scope.editorEnabledNum_4_top_skill = false;
			  	        };

			  	        $scope.saveNum_4_top_skill = function () {
			  	            $scope.Num_4_top_skill = $scope.editableNum_4_top_skill;
			  	            $scope.disableEditorNum_4_top_skill();
			  	        };

			  	        $scope.editorEnabledNum_5_top_skill = false;

			  	        $scope.enableEditorNum_5_top_skill = function () {
			  	            $scope.editorEnabledNum_5_top_skill = true;
			  	            $scope.editableNum_5_top_skill = $scope.Num_5_top_skill;
			  	        };

			  	        $scope.disableEditorNum_5_top_skill = function () {
			  	            $scope.editorEnabledNum_5_top_skill = false;
			  	        };

			  	        $scope.saveNum_5_top_skill = function () {
			  	            $scope.Num_5_top_skill = $scope.editableNum_5_top_skill;
			  	            $scope.disableEditorNum_5_top_skill();
			  	        };

			  	        $scope.editorEnabledNum_6_top_skill = false;

			  	        $scope.enableEditorNum_6_top_skill = function () {
			  	            $scope.editorEnabledNum_6_top_skill = true;
			  	            $scope.editableNum_6_top_skill = $scope.Num_6_top_skill;
			  	        };

			  	        $scope.disableEditorNum_6_top_skill = function () {
			  	            $scope.editorEnabledNum_6_top_skill = false;
			  	        };

			  	        $scope.saveNum_6_top_skill = function () {
			  	            $scope.Num_6_top_skill = $scope.editableNum_6_top_skill;
			  	            $scope.disableEditorNum_6_top_skill();
			  	        };

			  	        $scope.editorEnabledtitle_other_skill = false;

			  	        $scope.enableEditortitle_other_skill = function () {
			  	            $scope.editorEnabledtitle_other_skill = true;
			  	            $scope.editabletitle_other_skill = $scope.title_other_skill;
			  	        };

			  	        $scope.disableEditortitle_other_skill = function () {
			  	            $scope.editorEnabledtitle_other_skill = false;
			  	        };

			  	        $scope.savetitle_other_skill = function () {
			  	            $scope.title_other_skill = $scope.editabletitle_other_skill;
			  	            $scope.disableEditortitle_other_skill();
			  	        };


			  	        $scope.editorEnabledNum_1_other_skill = false;

			  	        $scope.enableEditorNum_1_other_skill = function () {
			  	            $scope.editorEnabledNum_1_other_skill = true;
			  	            $scope.editableNum_1_other_skill = $scope.Num_1_other_skill;
			  	        };

			  	        $scope.disableEditorNum_1_other_skill = function () {
			  	            $scope.editorEnabledNum_1_other_skill = false;
			  	        };

			  	        $scope.saveNum_1_other_skill = function () {
			  	            $scope.Num_1_other_skill = $scope.editableNum_1_other_skill;
			  	            $scope.disableEditorNum_1_other_skill();
			  	        };

			  	        $scope.editorEnabledNum_2_other_skill = false;

			  	        $scope.enableEditorNum_2_other_skill = function () {
			  	            $scope.editorEnabledNum_2_other_skill = true;
			  	            $scope.editableNum_2_other_skill = $scope.Num_2_other_skill;
			  	        };

			  	        $scope.disableEditorNum_2_other_skill = function () {
			  	            $scope.editorEnabledNum_2_other_skill = false;
			  	        };

			  	        $scope.saveNum_2_other_skill = function () {
			  	            $scope.Num_2_other_skill = $scope.editableNum_2_other_skill;
			  	            $scope.disableEditorNum_2_other_skill();
			  	        };

			  	        $scope.editorEnabledNum_3_other_skill = false;

			  	        $scope.enableEditorNum_3_other_skill = function () {
			  	            $scope.editorEnabledNum_3_other_skill = true;
			  	            $scope.editableNum_3_other_skill = $scope.Num_3_other_skill;
			  	        };

			  	        $scope.disableEditorNum_3_other_skill = function () {
			  	            $scope.editorEnabledNum_3_other_skill = false;
			  	        };

			  	        $scope.saveNum_3_other_skill = function () {
			  	            $scope.Num_3_other_skill = $scope.editableNum_3_other_skill;
			  	            $scope.disableEditorNum_3_other_skill();
			  	        };


			  	        $scope.editorEnabledNum_4_other_skill = false;

			  	        $scope.enableEditorNum_4_other_skill = function () {
			  	            $scope.editorEnabledNum_4_other_skill = true;
			  	            $scope.editableNum_4_other_skill = $scope.Num_4_other_skill;
			  	        };

			  	        $scope.disableEditorNum_4_other_skill = function () {
			  	            $scope.editorEnabledNum_4_other_skill = false;
			  	        };

			  	        $scope.saveNum_4_other_skill = function () {
			  	            $scope.Num_4_other_skill = $scope.editableNum_4_other_skill;
			  	            $scope.disableEditorNum_4_other_skill();
			  	        };

			  	        $scope.editorEnableduniversity_education = false;

			  	        $scope.enableEditoruniversity_education = function () {
			  	            $scope.editorEnableduniversity_education = true;
			  	            $scope.editableuniversity_education = $scope.university_education;
			  	        };

			  	        $scope.disableEditoruniversity_education = function () {
			  	            $scope.editorEnableduniversity_education = false;
			  	        };

			  	        $scope.saveuniversity_education = function () {
			  	            $scope.university_education = $scope.editableuniversity_education;
			  	            $scope.disableEditoruniversity_education();
			  	        };

			  	        $scope.editorEnableddegree_education = false;

			  	        $scope.enableEditordegree_education = function () {
			  	            $scope.editorEnableddegree_education = true;
			  	            $scope.editabledegree_education = $scope.degree_education;
			  	        };

			  	        $scope.disableEditordegree_education = function () {
			  	            $scope.editorEnableddegree_education = false;
			  	        };

			  	        $scope.savedegree_education = function () {
			  	            $scope.degree_education = $scope.editabledegree_education;
			  	            $scope.disableEditordegree_education();
			  	        };

			  	        $scope.editorEnabledmajor_falcuty_education = false;

			  	        $scope.enableEditormajor_falcuty_education = function () {
			  	            $scope.editorEnabledmajor_falcuty_education = true;
			  	            $scope.editablemajor_falcuty_education = $scope.major_falcuty_education;
			  	        };

			  	        $scope.disableEditormajor_falcuty_education = function () {
			  	            $scope.editorEnabledmajor_falcuty_education = false;
			  	        };

			  	        $scope.savemajor_falcuty_education = function () {
			  	            $scope.major_falcuty_education = $scope.editablemajor_falcuty_education;
			  	            $scope.disableEditormajor_falcuty_education();
			  	        };
			  	        $scope.editorEnabledtime_education = false;

			  	        $scope.enableEditortime_education = function () {
			  	            $scope.editorEnabledtime_education = true;
			  	            $scope.editabletime_education = $scope.time_education;
			  	        };

			  	        $scope.disableEditortime_education = function () {
			  	            $scope.editorEnabledtime_education = false;
			  	        };

			  	        $scope.savetime_education = function () {
			  	            $scope.time_education = $scope.editabletime_education;
			  	            $scope.disableEditortime_education();
			  	        };

			  	        $scope.editorEnabledfollowers = false;

			  	        $scope.enableEditorfollowers = function () {
			  	            $scope.editorEnabledfollowers = true;
			  	            $scope.editablefollowers = $scope.followers;
			  	        };

			  	        $scope.disableEditorfollowers = function () {
			  	            $scope.editorEnabledfollowers = false;
			  	        };

			  	        $scope.savefollowers = function () {
			  	            $scope.followers = $scope.editablefollowers;
			  	            $scope.disableEditorfollowers();
			  	        };
                    }]);
